...
pairs(PAIR_QUIZ[,1:3], col = "dark green", main = "hehe")
```
...
plot(PAIR_QUIZ, col = "dark green", main = "Hekhok")
...
The null hypothesis will be rejected if $f_0$ is greater than $f_{0.05,2,6}$
